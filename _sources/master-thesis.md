...
The male dataset made available in this work can be downloaded [here](https://www.kaggle.com/datasets/mediatechlab/gneutralspeech), and a [live demo](https://www.kaggle.com/code/pedrohlopes/portuguese-tts) for TTS with the base voice is also available. See the [datasets page](datasets.md) for the full recording specification and how the corpus was built.
...
In this experiment, we aimed to measure the impact of gender-balanced data and the importance of transferring data from the same gender as the target voice. For this, we started by training the same neutral voice from the first experiment and the newly developed [female voice dataset](https://www.kaggle.com/datasets/mediatechlab/g-neutral-speech-female), with the exact same 10333 phrases as described in the [article](https://biblioteca.sbrt.org.br/articlefile/4464.pdf). From these pretrained models, we proceeded to a voice transfer experiment, where the female and male models were finetuned with other male and female voices, but with smaller amounts of data. Here are some examples of the resulting voices, from unseen text data.
...
```{code-cell} ipython3
:tags: ["remove_input"]
ipd.Audio('audios/vc_data/ref_speaker1.wav')
```
...
```{code-cell} ipython3
:tags: ["remove_input"]
ipd.Audio('audios/vc_data/ref_speaker2.wav')
```
...
```{code-cell} ipython3
:tags: ["remove_input"]
ipd.Audio('audios/vc_data/ref_speaker3.wav')
```
...
```{code-cell} ipython3
:tags: ["remove_input"]
ipd.Audio('audios/vc_data/vc_1to2.wav')
```
...
```{code-cell} ipython3
:tags: ["remove_input"]
ipd.Audio('audios/vc_data/vc_1to3.wav')
```
...
```{code-cell} ipython3
:tags: ["remove_input"]
ipd.Audio('audios/vc_data/vc_2to1.wav')
```
...
```{code-cell} ipython3
:tags: ["remove_input"]
ipd.Audio('audios/vc_data/vc_2to3.wav')
```
...
```{code-cell} ipython3
:tags: ["remove_input"]
ipd.Audio('audios/vc_data/vc_3to1.wav')
```
...
```{code-cell} ipython3
:tags: ["remove_input"]
ipd.Audio('audios/vc_data/vc_3to2.wav')
```
...
```{code-cell} ipython3
:tags: ["remove_input"]
ipd.Audio('audios/vc_data/ms_speaker1.wav')
```
...
```{code-cell} ipython3
:tags: ["remove_input"]
ipd.Audio('audios/vc_data/ms_speaker2.wav')
```
...
```{code-cell} ipython3
:tags: ["remove_input"]
ipd.Audio('audios/vc_data/ms_speaker3.wav')
```
...
```{code-cell} ipython3
:tags: ["remove_input"]
ipd.Audio('audios/style_data/style_nolabel.wav')
```
...
```{code-cell} ipython3
:tags: ["remove_input"]
ipd.Audio('audios/style_data/style_excited.wav')
```
...
```{code-cell} ipython3
:tags: ["remove_input"]
ipd.Audio('audios/style_data/style_sad.wav')
```
...
```{code-cell} ipython3
:tags: ["remove_input"]
ipd.Audio('audios/style_data/style_serious.wav')
```
...
```{code-cell} ipython3
:tags: ["remove_input"]
ipd.Audio('audios/style_data/style_narrative.wav')
```
...
```{code-cell} ipython3
:tags: ["remove_input"]
ipd.Audio('audios/phoneme_control/ctrl_none.wav')
```
...
```{code-cell} ipython3
:tags: ["remove_input"]
ipd.Audio('audios/phoneme_control/ctrl_flat_pitch.wav')
```
